...
public actor DefaultInstrumentation: InstrumentationManager {
    ...
    func initializeTracing() {
        ...
        urlComponents.host = configuration.otlpHost
        urlComponents.scheme = configuration.otlpScheme
        urlComponents.port = configuration.otlpPort
        urlComponents.path = Configuration.otlpTracesEndpoint
        guard let tracesUrl = urlComponents.url else {
    ...
    func initializeLogs() {
        ...
        urlComponents.scheme = configuration.otlpScheme
        urlComponents.port = configuration.otlpPort
        urlComponents.path = Configuration.otlpLogsEndpoint
        guard let logsUrl = urlComponents.url else {
            return print("Logs exporter URL is invalid")
        }
    ...
    func initializeMetrics() {
        ...
        urlComponents.scheme = configuration.otlpScheme
        urlComponents.port = configuration.otlpPort
        urlComponents.path = Configuration.otlpMetricsEndpoint
        guard let metricsUrl = urlComponents.url else {
            return print("Metrics exporter URL is invalid")
        }
