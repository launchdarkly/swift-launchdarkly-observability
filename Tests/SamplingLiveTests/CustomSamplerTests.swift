        ...
        let config = SamplingConfig(
            spans: [
                .init(
                    attributes: [
                        .init(
                            key: .basic(value: "http.method"),
                            attribute: .basic(value: "POST")
                        )
                    ],
                    samplingRatio: 75
                )
        ...
        let config = SamplingConfig(
            spans: [
                .init(
                    attributes: [
                        .init(
                            key: .basic(value: "http.status_code"),
                            attribute: .basic(value: 500)
                        )
                    ],
                    samplingRatio: 100
                )
    ...
    func shouldMatchSpanBasedOnEventName() {
        let config = SamplingConfig(
            spans: [
                .init(
                    events: [
                        .init(name: .basic(value: "test-event"))
                    ],
                    samplingRatio: 42
                )
            ]
                ...
                .init(
                    events: [
                        .init(
                            attributes: [
                                .init(
                                    key: .basic(value: "error.type"),
                                    attribute: .basic(value: "network")
                                )
                            ]
                        )
                    ],
                    ...
                    events: [
                        .init(
                            attributes: [
                                .init(
                                    key: .basic(value: "error.type"),
                                    attribute: .basic(value: "database")
                                )
                            ]
                        )
                    ],
